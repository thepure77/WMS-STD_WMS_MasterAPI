...
{
    [Route("api/Menu")]
    public class MenuPopupController : Controller
    {
        [HttpPost("filter")]
        public IActionResult filter([FromBody]JObject body)
        {
            try
            {
                var service = new MenuPopupService();
                var Models = new MenuPopupViewModel();
                Models = JsonConvert.DeserializeObject<MenuPopupViewModel>(body.ToString());
