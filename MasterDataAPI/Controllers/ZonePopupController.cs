...
{
    [Route("api/ZonePopup")]
    public class ZonePopupController : Controller
    {
        [HttpPost("filter")]
        public IActionResult filter([FromBody]JObject body)
        {
            try
            {
                var service = new ZonePopupService();
                var Models = new ZonePopupViewModel();
                Models = JsonConvert.DeserializeObject<ZonePopupViewModel>(body.ToString());
