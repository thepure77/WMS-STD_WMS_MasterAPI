...
{
    public class SearchBusinessUnitViewModel : Pagination
    {
    ...
    public class actionResultBusinessUnitViewModel
    {
        public IList<SearchBusinessUnitViewModel> itemsBusinessUnit { get; set; }
