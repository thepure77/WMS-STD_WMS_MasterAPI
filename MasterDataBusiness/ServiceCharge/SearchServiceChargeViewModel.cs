...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class SearchServiceChargeViewModel : Pagination
    {
    ...
    public class actionResultServiceChargeViewModel
    {
        public IList<SearchServiceChargeViewModel> items { get; set; }
