...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class SearchProductSubTypeViewModel : Pagination
    {
    ...
    public class actionResultProductSubTypeViewModel
    {
        public IList<SearchProductSubTypeViewModel> itemsProductSubType { get; set; }
