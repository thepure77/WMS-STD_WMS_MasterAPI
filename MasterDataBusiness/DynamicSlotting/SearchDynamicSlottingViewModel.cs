...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class SearchDynamicSlottingViewModel : Pagination
    {
    ...
    public class actionResultDynamicSlottingViewModel
    {
        public IList<SearchDynamicSlottingViewModel> itemsDynamicSlotting { get; set; }
