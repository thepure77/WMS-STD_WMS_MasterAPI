...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class SearchSoldToViewModel : Pagination
    {
        ...
        public string createdatesoldto_date { get; set; }
        public string createdatesoldto_date_to { get; set; }
    }

    public class SearchSoldToInClauseViewModel : Pagination
    {
        public List<Guid> List_SoldTo_Index { get; set; }

        public List<string> List_SoldTo_Id { get; set; }
    }

    public class actionResultSoldToViewModel
    {
        public IList<SearchSoldToViewModel> itemsSoldTo { get; set; }
