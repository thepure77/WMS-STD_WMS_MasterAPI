...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class SearchServiceChargeListViewModel : Pagination
    {
    ...
    public class actionResultServiceCharge
    {
        public IList<SearchServiceChargeListViewModel> items { get; set; }
