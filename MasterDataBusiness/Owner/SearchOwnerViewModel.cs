...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class SearchOwnerViewModel : Pagination
    {
        ...
        public List<OwnerViewModel> listOwnerViewModel { get; set; }
}
    public class actionResultOwnerViewModel
    {
        public IList<SearchOwnerViewModel> itemsOwner { get; set; }
        public Pagination pagination { get; set; }
    }

    public class SearchOwnerInClauseViewModel : Pagination
    {
        public List<Guid> List_Owner_Index { get; set; }

        public List<string> List_Owner_Id { get; set; }
        public List<string> List_Owner_Ref { get; set; }
    }
}
