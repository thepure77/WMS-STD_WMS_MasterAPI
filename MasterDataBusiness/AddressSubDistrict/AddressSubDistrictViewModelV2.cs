...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class AddressSubDistrictViewModelV2 : Pagination
    {
        ...
        public string subDistrict_SecondName { get; set; }
    ...
    public class actionResultSubDistrictViewModelV2
    {
        public IList<AddressSubDistrictViewModelV2> itemsSubDistrict { get; set; }
