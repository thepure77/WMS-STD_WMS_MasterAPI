...
namespace MasterDataBusiness.ViewModels
{
    ...
    public class SearchRuleConditionOperationViewModel : Pagination
    {
    ...
    public class actionResultRuleConditionOperationViewModel
    {
        public IList<SearchRuleConditionOperationViewModel> itemsRuleConditionOperation { get; set; }
