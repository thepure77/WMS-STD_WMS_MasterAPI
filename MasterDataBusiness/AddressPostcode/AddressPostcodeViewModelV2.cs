...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class AddressPostcodeViewModelV2 : Pagination
    {
    ...
    public class actionResultPostcodeViewModelV2
    {
        public IList<AddressPostcodeViewModelV2> itemsPostcode { get; set; }
