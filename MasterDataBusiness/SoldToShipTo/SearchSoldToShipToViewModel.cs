...
namespace MasterDataBusiness.ViewModels
{
    ...
    public class SearchSoldToShipToViewModel : Pagination
    {
        ...
        public class actionResultSoldToShipToViewModel
        {
            public IList<SearchSoldToShipToViewModel> itemsSoldToShipTo { get; set; }
