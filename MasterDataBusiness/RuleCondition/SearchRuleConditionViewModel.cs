...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class SearchRuleConditionViewModel : Pagination
    {
    ...
    public class actionResultRuleConditionViewModel
    {
        public IList<SearchRuleConditionViewModel> itemsRuleCondition { get; set; }
