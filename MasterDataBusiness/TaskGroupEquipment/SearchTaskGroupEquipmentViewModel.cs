...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class SearchTaskGroupEquipmentViewModel : Pagination
    {
    ...
    public class actionResultTaskGroupEquipmentViewModel
    {
        public IList<SearchTaskGroupEquipmentViewModel> itemsTaskGroupEquipment { get; set; }
