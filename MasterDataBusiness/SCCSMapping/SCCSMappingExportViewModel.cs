...
{
    public class SCCSMappingExportViewModel : Pagination
    {
    ...
    public class SCCSMappingActionResultExportViewModel
    {
        public IList<SCCSMappingExportViewModel> itemsSCCSMapping { get; set; }
