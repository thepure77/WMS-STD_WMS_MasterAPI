...
namespace MasterDataBusiness.ViewModels
{
    ...
    public  class SearchShippingMethodViewModel : Pagination
    {
    ...
    public class actionResultShippingMethodViewModel
    {
        public IList<SearchShippingMethodViewModel> itemsShippingMethod { get; set; }
