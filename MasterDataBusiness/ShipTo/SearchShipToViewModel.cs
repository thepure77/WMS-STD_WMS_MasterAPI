...
namespace MasterDataBusiness.ViewModels
{
    ...
    public class SearchShipToViewModel : Pagination
    {
        ...
        public List<ShipToViewModel> listShipToViewModel { get; set; }
    }
    public class SearchShipToInClauseViewModel : Pagination
    {
    ...
    public class actionResultShipToViewModel
    {
        public IList<SearchShipToViewModel> itemsShipTo { get; set; }
